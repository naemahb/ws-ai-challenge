...
const AI_RECOMMENDATIONS: Record<string, string> = {
  ...
  rrsp_high_income: 'Based on your income bracket and the March 2 RRSP deadline, the AI recommends contributing $15,000 to your RRSP before the deadline. At your marginal rate of approximately 43%, this generates an estimated $6,450 in tax savings — an immediate 43% return on capital deployed.',
